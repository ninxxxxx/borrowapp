	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.userNo}">
				<li class="fieldcontain">
					<span id="userNo-label" class="property-label"><g:message code="user.userNo.label" default="User No" /></span>
					
						<span class="property-value" aria-labelledby="userNo-label"><g:fieldValue bean="${userInstance}" field="userNo"/></span>
